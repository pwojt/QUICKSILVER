...
#ifdef STM32F7
#define SYS_CLOCK_FREQ_HZ 216000000L
#define PWM_CLOCK_FREQ_HZ 216000000L
#define SPI_CLOCK_FREQ_HZ (SYS_CLOCK_FREQ_HZ / 4L)
...
#ifdef STM32H7
#define SYS_CLOCK_FREQ_HZ 480000000L
#define PWM_CLOCK_FREQ_HZ (SYS_CLOCK_FREQ_HZ / 2L)
#define SPI_CLOCK_FREQ_HZ (SYS_CLOCK_FREQ_HZ / 4L)
