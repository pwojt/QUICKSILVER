...
FAST_RAM task_t tasks[TASK_MAX] = {
    ...
    [TASK_BLACKBOX] = CREATE_TASK("BLACKBOX", NULL, TASK_MASK_ALWAYS, TASK_PRIORITY_MEDIUM, 0, NULL, blackbox_update),
#endif
    [TASK_OSD] = CREATE_TASK("OSD", NULL, TASK_MASK_ALWAYS, TASK_PRIORITY_MEDIUM, 0, NULL, osd_display),
